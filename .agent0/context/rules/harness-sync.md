...
- **`COPY_CHECK_FILES`** — literal paths: `AGENTS.md`, `.mcp.json.example`, `.codex/hooks.json`, `.codex/config.toml.example`, `.gitleaks.toml`, `.githooks/pre-commit`, `.agent0/tools/lib/managed-block.sh`, `.agent0/memory/.gitkeep`, `.agent0/memory.config.json`, `.agent0/routines/.gitkeep`.
