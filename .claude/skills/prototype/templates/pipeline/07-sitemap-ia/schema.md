...
The YAML output binds to `.claude/skills/prototype/references/sitemap-schema.md`. That doc is the canonical schema; this file is the per-step calibration.
...
See `.claude/skills/prototype/references/sitemap-schema.md` § "Validation rules" for the full 10-rule list. Highlights:
...
- `.claude/skills/prototype/references/sitemap-schema.md` — canonical binding schema
- `.claude/skills/prototype/references/delegation-briefs.md` § Step 07
